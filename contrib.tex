...
\medskip
%<<<2
We believe it very important that the international standards
...
ans iven the current state-of-the-art,
...
In this note, we don't make an explicit proposal of an elliptic curve,
...
international standard should include a family of curves
...
so that we do not believe that these attacks have to be considered.
...
is be a square, which is unoptimal against side channel attacks
