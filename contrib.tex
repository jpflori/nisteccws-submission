...
We note however that this property
does not protect against all curve-changing attacks.
Moreover, the curve and its quadratic twist
do not have the same side-channel behaviour,
since exactly one of the two curves
contains a special point of the form~$(0, y)$.
