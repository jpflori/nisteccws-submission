...
so that each user might select the appropriate curve
...
to check that the curve is indeed suitable,
...
such as the observation of sunspots, a physical lottery result,
