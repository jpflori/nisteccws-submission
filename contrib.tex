...
this does not give confidence enough to trust the curve.
...
{\bf Security. }
What criteria should a secure elliptic curve verify, what flexibility is
available and what kind of diversity is desirable?\\
{\bf Transparency. }
...
\subsection{Resistance depending upon implementation}
\label{ss:side}
...
We note that some of these conditions are satisfied
...
sampling.seed = \texttt{2015}\\
condition.cofactor = \texttt{1}\\
condition.twist\_prime = \texttt{True}\\
condition.embedding\_degree = \texttt{7}\\
condition.twist\_embedding\_degree = \texttt{7}\\
condition.class\_number = \texttt{7}

\header{Curve}
$(2017, -3, 625)$\\
order = $2063$, point = (0, 25)\\
twist\_order = $1971$\\
disc\_factorization = $(6043)$\\
...
\section{The status of current families of elliptic curves}
