...
\hypersetup{pdftitle={Flexibility and transparency for ECC},%
  pdfauthor={Jean-Pierre Flori and Jérôme Plût and Jean-René Reinhard},%
  pdfsubject={Elliptic Curve Cryptography},%
  pdfcreator={Jean-Pierre Flori and Jérôme Plût and Jean-René Reinhard},%
  pdfproducer={Jean-Pierre Flori and Jérôme Plût and Jean-René Reinhard},%
  pdfkeywords={mathematics} {cryptography} {elliptic curves} {discrete logarithm problem},
}
...
the properties they verify
or the process used to generate them.
Such analyses often come with
a list of security or performance criteria a curve should verify
and a proposal on how to correctly generate such a curve so that it can be
...
\XXX il faut une famille qui maximise la sécurité,
donc entièrement pseudo-aléa et sans cofacteur.

In this note, we only deal with the first part:
\begin{itemize}
\item what should a secure elliptic curve verify, what flexibility is available?
