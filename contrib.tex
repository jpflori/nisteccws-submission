...
\author{Jean-Pierre Flori\thanks{{\noindent}Agence nationale de la sécurité des systèmes d'information\newline%
...
some attacks exist in particular cases~\cite{jc2013jv,asia1999dgm}.
Moreover, the multiplicative discrete logarithm
in extension fields is known to be
quasi-polynomial in small characteristic~\cite{euro2014bgjt}.
...
for pairing-friendly curves~\cite{jc2010fst}
