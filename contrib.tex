...
%    \def\@makefnmark{\mbox{\@textsuperscript{\normalfont\@thefnmark}}}%
...
we detail what we think are the best choices for optimal security.
\\{\bf Transparency. }
...
Therefore it has a negligible probability of being~$(\log p)^{O(1)}$-smooth
...
or, equivalently, to a twisted Edwards curve.
